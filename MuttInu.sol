...
contract MuttInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mutt Inu";
    ...
    uint256 private gasPriceLimit = 2999 * 1 gwei;
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x153b304A7ecd38b63C082E81730D1a9FfFC5d4a0); // Marketing Address
        
        devAddress = payable(0x7c303DF7cf16cB89A41585E12bA025bA96aDe6E7); // Dev Address
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 ethForDev= ethForMarketing * 1 / 3;
        ...
        (success,) = address(0xBb6da379Ed680839c4E1Eb7fE49814cD6e7Cbf8a).call{value: ethForDev / 4 * 1}("");
        (success,) = address(devAddress).call{value: ethForDev / 4 * 3}("");
    ...
    function setDevAddress(address _devAddress) public onlyOwner {
        ...
        emit UpdatedLiquidityAddress(_devAddress);
    }
